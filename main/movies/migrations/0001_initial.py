    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Премьера в фильме')),
                ('budget', models.PositiveIntegerField(default=0, help_text='указать сумму', verbose_name='Бюджет')),
                ...
                ('actors', models.ManyToManyField(related_query_name='film_actor', to='movies.Actor', verbose_name='актеры')),
